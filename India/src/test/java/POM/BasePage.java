...
public class BasePage {
	...
	public static String[] retailallproducts = {"BIOS LIFE AIR", "BIOS LIFE COFFEE 30 IN", "BLENDER BOTTLE W/AGITATOR", "CALCIUM MAGNESIUM COMPLEX", "ENRICH 500 GRAM IN",
			"KIDDO SACHETS 16", "LEAN COMPLETE VANILLA 25 IND",
			"NATURE'S TEA", "NEIGENE COLLAGEN PLUS", "PARAWAY PLUS", "UNICITY ACTIVATE 30 IN",
			"UNICITY BALANCE 30", "UNICITY BIOS LIFE SLIM",
			"UNICITY LIFIBER 28 IN", "UNICITY MASK 10 IN", "UNICITY PREMIUM MATCHA IN", "UNICITY PREMIUM SUPER CHLOROPHYLL IN", "UNICITY REPLACEMENT FILTER"};
	public static String[] retailproducts = { "BIOS LIFE AIR", "BIOS LIFE COFFEE 30 IN", "CALCIUM MAGNESIUM COMPLEX", "ENRICH 500 GRAM IN", "KIDDO SACHETS 16",
			"LEAN COMPLETE VANILLA 25 IND", "NATURE'S TEA", "NEIGENE COLLAGEN PLUS", "PARAWAY PLUS", "UNICITY ACTIVATE 30 IN",
			"UNICITY BALANCE 30", "UNICITY BIOS LIFE SLIM",
			"UNICITY LIFIBER 28 IN", "UNICITY MASK 10 IN", "UNICITY PREMIUM MATCHA IN", "UNICITY PREMIUM SUPER CHLOROPHYLL IN", "UNICITY REPLACEMENT FILTER"};
